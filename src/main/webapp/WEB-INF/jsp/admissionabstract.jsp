...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/furnitureworld/DocumentsProcess/searchForStudents";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/furnitureworld/DocumentsProcess/generateAdmissionAbstract" method="POST">
