...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/furnitureworld/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/furnitureworld/StudentProcess/exportDataForStudents" method="POST">
