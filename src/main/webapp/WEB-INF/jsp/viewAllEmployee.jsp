...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/kingwell/EmployeeProcess/deleteMultiple" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${employeeList}" var="employee">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/kingwell/EmployeeProcess/ViewDetails?id=<c:out value='${employee.tid}'/>"><c:out value="${employee.teachername}"/></a></td>
