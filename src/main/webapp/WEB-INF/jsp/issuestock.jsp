...
<script type="text/javascript">
	...
	var itemlist=[
        <c:forEach varStatus="status" items="${messstockitemdetailslist}" var="itemlist">{
        		...
        		unitprice:'<c:out default="0" value="${itemlist.batchno}" />',
                ...
                purchaseprice:'<c:out default="0" value="${itemlist.itemunitprice}" />',
	...
	function calculate(value2) {
 	        ...
 	        if(issueQuantity !== ""){
	 	        ...
	 	        if(parseFloat(issueQuantity)>0 && (parseFloat(issueQuantity,10)<=parseFloat(availableQuantity,10))){
	 	           ...
	 	           priceonlygst.value= parseFloat(onlygstprice).toFixed(2);
