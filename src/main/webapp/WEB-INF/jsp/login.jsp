...
.btn:hover, .btn:focus{
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<h2 style="font-weight: bold;">Hisabaat<!-- <img border="0" style="vertical-align: text-bottom;height: 120px;width: 200px;" alt="ideoholic" src="/hisabaat/images/shaheenwhitelogo.png"> --></h2></span>
