...
.btn:hover, .btn:focus{
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<h3 style="font-weight: bold;">Furniture World<!-- <img border="0" style="vertical-align: text-bottom;height: 120px;width: 200px;" alt="ideoholic" src="/hisabaat/images/shaheenwhitelogo.png"> --></h3></span>
