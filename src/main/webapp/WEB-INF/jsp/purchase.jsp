...
<script type="text/javascript">
	...
	function saveInventory() {
		...
		if(form1.checkValidity()) {
			form1.action = "/furnitureworld/MessItemsProcess/savePurchase";
			form1.method = "POST";
			form1.submit();
		}
	...
	function cancelPurchase() {
				...
				var form1 = document.getElementById("form1");
				form1.action = "/furnitureworld/MessItemsProcess/cancelPurchase";
				form1.method = "POST";
				form1.submit();
	...
	function addRow() {
        ...
        var col5="<td class='dataTextInActive'><input type='text' value='0'  name='price' id=price_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;'/></td>";
        var col6="<td class='dataTextInActive'><input type='text' value='0'  name='purchaseprice' id=purchaseprice_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;' onkeyup='calculate("+rowCount+")'/></td>";
        var col7="<td class='dataTextInActive'><input type='text' value='0'  name='sgst' id=sgst_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;' onkeyup='calculate("+rowCount+")'/></td>";
        var col8="<td class='dataTextInActive'><input type='text' value='0'  name='cgst' id=cgst_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;' onkeyup='calculate("+rowCount+")'/></td>";
...
<script type="text/javascript">
            ...
            function openPopup(invoicedetailsid,date, supplierrefno, name, invoicetotal){
        			...
        			xmlHttp.open("GET", "/furnitureworld/stockentry/mrvDetails?invoicedetailsid="+invoicedetailsid+"&entrydate="+date+"&supplierreferenceno="+supplierrefno+"&suppliername="+name+"&invoicetotal="+invoicetotal+"",true);
        			xmlHttp.send(null);
					...
					<table style="margin-left: auto;margin-right: auto;border: 1px solid black;" id="dataTable">
						...
						<tbody>						
							...
							<tr>
								...
								<td colspan="8" align="right" style="font-weight: bold;">Transportation & Labour Charges&nbsp;&nbsp;</td>
								<td align="center"><input type="text"
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
             ...
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/furnitureworld/MessItemsProcess/purchaseItems?page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/furnitureworld/MessItemsProcess/purchaseItems?page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/furnitureworld/MessItemsProcess/purchaseItems?page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
