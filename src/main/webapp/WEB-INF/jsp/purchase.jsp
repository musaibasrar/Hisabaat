...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#anim").change(function() {
			$("#dateofexpiry").datepicker("option", "showAnim", $(this).val());
		});
	});
</script>
...
<script type="text/javascript">
	...
	function addRow() {
        ...
        var col4="<td class='dataTextInActive'><input type='number' class='textfieldvaluesshortsdate' name='dateofexpiry' id=dateofexpiry_"+rowCount+" placeholder='dd' style='font-size: 14px;' min='1' max='31'/>/<input type='number' placeholder='mm' class='textfieldvaluesshortsdate' name='monthofexpiry' id=monthofexpiry_"+rowCount+" style='font-size: 14px;' min='1' max='12'/>/<input type='text' class='textfieldvaluesshortsdate' name='yearofexpiry' placeholder='yyyy' id=yearofexpiry_"+rowCount+" style='font-size: 14px;'/></td>";
        var col5="<td class='dataTextInActive'><input  value='0'   name='itemsunitofmeasure'  id=items_unitofmeasure_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;' readonly/></td>";
        var col6="<td class='dataTextInActive'><input type='text' value='0'   name='itemsquantity'  id=items_quantity_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;' onkeyup='calculate("+rowCount+")'/></td>";
        var col7="<td class='dataTextInActive'><input type='text' value='0'  name='price' id=price_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;'/></td>";
        var col8="<td class='dataTextInActive'><input type='text' value='0'  name='purchaseprice' id=purchaseprice_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;' onkeyup='calculate("+rowCount+")'/></td>";
        var col9="<td class='dataTextInActive'><input type='text' value='0'  name='sgst' id=sgst_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;' onkeyup='calculate("+rowCount+")'/></td>";
        var col10="<td class='dataTextInActive'><input type='text' value='0'  name='cgst' id=cgst_"+rowCount+" class='textfieldvaluesshorts' style='font-size: 14px;' onkeyup='calculate("+rowCount+")'/></td>";
					...
					<table style="margin-left: auto;margin-right: auto;border: 1px solid black;" id="dataTable">
						...
						<tbody>						
							...
							<tr>
								...
								<td colspan="11" align="right" style="font-weight: bold;">Total(Incl. GST)&nbsp;&nbsp;</td>
								<td align="center"><input type="text"
							...
							<tr>
								...
								<td colspan="11" align="right" style="font-weight: bold;">Transportation & Labour Charges&nbsp;&nbsp;</td>
								<td align="center"><input type="text"
							...
							<tr>
								...
								<td colspan="11" align="right" style="font-weight: bold;">Grand Total(Incl. GST)&nbsp;&nbsp;</td>
								<td align="center"><input type="text"
