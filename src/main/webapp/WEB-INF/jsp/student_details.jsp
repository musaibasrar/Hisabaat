...
<html>
    <head>
        ...
        <script type="text/javascript" language="JavaScript" src="/asianagencies/js/motionpack.js"></script>
        ...
        <script type="text/javascript">
            ...
            function updateStudent(){
                ...
                form1.action="/asianagencies/StudentProcess/updateStudentDetails?id=<c:out value='${student.sid}'/>&urlbranchid=<c:out value='${student.branchid}'/>";
                form1.submit();
            }
...
%>
    ...
    <%-- <div class="accordion" style="width: 100%;height: 100%">
                ...
                <div>
                    ...
                    <td>
                    <a download="studentdoc1.jpg" href="/asianagencies/data:image/jpg;base64,<c:out value="${student.studentdoc1}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc2.jpg" href="/asianagencies/data:image/jpg;base64,<c:out value="${student.studentdoc2}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc3.jpg" href="/asianagencies/data:image/jpg;base64,<c:out value="${student.studentdoc3}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc4.jpg" href="/asianagencies/data:image/jpg;base64,<c:out value="${student.studentdoc4}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc5.jpg" href="/asianagencies/data:image/jpg;base64,<c:out value="${student.studentdoc5}"/>">Download</a>
                    </td>
                    </tr>
                    </table>
                </div>
    ...
    <%-- <div class="accordion" style="width: 100%;height: 100%">
                    ...
                    <tbody>
                        <c:forEach items="${receiptinfo}" var="receiptinfo">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" target="_blank" href="/asianagencies/FeesCollection/ViewDetails?id=<c:out value='${receiptinfo.receiptnumber}'/>&sid=<c:out value='${student.sid}'/>">View Details</a></td>
        ...
        <script>
            ...
            function Cancel(){
                var form1=document.getElementById("form1");
                form1.action="/asianagencies/StudentProcess/viewAll";
                form1.submit();
            }
            
            function Print(){
                var form1=document.getElementById("form1");
                form1.action="/asianagencies/StudentProcess/printAdmissionForm";
                form1.submit();
            }
        </script>
    </body>
