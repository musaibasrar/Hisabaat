...
<script type="text/javascript">
	...
	function addHolidays() {
		...
		form1.action = "/furnitureworld/AttendanceProcess/addHolidays";
		form1.method = "POST";
		form1.submit();
	...
	function searchForEmployees(staffName, staffDepartment){
		var form1 = document.getElementById("form1");
		form1.action = "/furnitureworld/AttendanceProcess/searchEmployees?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function addStudentAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action = "/furnitureworld/AttendanceProcess/addStudentAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
	...
	function addStaffAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action = "/furnitureworld/AttendanceProcess/addStaffAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/furnitureworld/MarksDetailsProcess/updateMarks" method="POST">
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Name<img
							...
							src="/furnitureworld/images/sort_both.png" /></th>
				...
				<tbody>
					   ...
					   <c:forEach items="${employeeList}" var="employee">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/furnitureworld/EmployeeProcess/ViewDetails?id=<c:out value='${employee.tid}'/>"><c:out value="${employee.teachername}"/></a></td>
