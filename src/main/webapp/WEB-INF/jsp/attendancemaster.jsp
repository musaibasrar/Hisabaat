...
<script type="text/javascript">
	...
	function addHolidays() {
		...
		form1.action = "/hisabaat/AttendanceProcess/addHolidays";
		form1.method = "POST";
		form1.submit();
	...
	function searchForEmployees(staffName, staffDepartment){
		var form1 = document.getElementById("form1");
		form1.action = "/hisabaat/AttendanceProcess/searchEmployees?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function addStudentAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action = "/hisabaat/AttendanceProcess/addStudentAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
	...
	function addStaffAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action = "/hisabaat/AttendanceProcess/addStaffAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/hisabaat/MarksDetailsProcess/updateMarks" method="POST">
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Name<img
							...
							src="/hisabaat/images/sort_both.png" /></th>
