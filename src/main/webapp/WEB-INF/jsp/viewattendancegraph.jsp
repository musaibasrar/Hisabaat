...
<script src="/kingwell/js/Chart.js"></script>
...
<link rel="stylesheet" href="/kingwell/css/graph/jquery.jqplot.min.css">
  ...
  <script type="text/javascript" src="/kingwell/js/datePicker/jquery-1.7.1.js"></script>
        ...
        <script src="/kingwell/js/jquery.jqplot.min.js" ></script>
        <script src="/kingwell/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMonthly() {
		...
		form1.action = "/kingwell/AttendanceProcess/searchStudentAttendanceDetailsMonthly";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetailsMonthlyGraph() {
		var form1 = document.getElementById("form1");
		form1.action = "/kingwell/AttendanceProcess/searchStudentAttendanceDetailsMonthlyGraph";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "/kingwell/AttendanceProcess/searchStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/kingwell/AttendanceProcess/updateStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form id="form1" action="/kingwell/StampFeesProcess/applyFees" method="POST">
