...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/asianagencies/FeesCollection/searchFeesReport";
		form1.method = "POST";
		form1.submit();
...
<script type="text/javascript">
    ...
    function getFeesCategory() {
		...
		var selected=document.getElementById('academicyear').value;
			...
			xmlHttp.open("GET", "/asianagencies/StampFeesProcess/showFeesDetailsYearly?year="+selected,true);
			xmlHttp.send(null);
	}
...
%>
<body>
	<form id="form1" action="/asianagencies/FeesCollection/exportDataForStudentsFeesReport" method="POST">
