...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/kingwell/FeesCollection/searchFeesReport";
		form1.method = "POST";
		form1.submit();
...
<script type="text/javascript">
    ...
    function getFeesCategory() {
		...
		var selected=document.getElementById('academicyear').value;
			...
			xmlHttp.open("GET", "/kingwell/StampFeesProcess/showFeesDetailsYearly?year="+selected,true);
			xmlHttp.send(null);
	}
...
%>
<body>
	<form id="form1" action="/kingwell/FeesCollection/exportDataForStudentsFeesReport" method="POST">
