...
<script type="text/javascript">
	...
	function searchForEmployees(staffName, staffDepartment){
		...
		form1.action = "/furnitureworld/HrProcess/searchEmployees?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function addLeaves() {
		var form1 = document.getElementById("form1");
		form1.action = "/furnitureworld/HrProcess/addLeaves";
		form1.method = "POST";
		form1.submit();
	}
