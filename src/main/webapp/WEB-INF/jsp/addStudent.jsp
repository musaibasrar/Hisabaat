...
<script src="/kingwell/js/datePicker/jquery-1.7.1.js"></script>
<script src="/kingwell/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/kingwell/js/datePicker/ui/jquery.ui.tabs.js"></script>
...
<script src="/kingwell/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script src="/kingwell/JavaScript/actb.js"></script>
<script src="/kingwell/JavaScript/common.js"></script>
...
<script type="text/javascript">
			...
			function checkContactNo() {
				...
				var selected=document.getElementById('addclass').value;
					...
					xmlHttp.open("GET", "/kingwell/StudentProcess/checkContactNo?contactnumber="+selected,true);
					xmlHttp.send(null);
			}
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/kingwell/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
							...
							function generateBill() {
								...
								if(form1.checkValidity()) {
									form1.savestudent.disabled = true;
									form1.action = "/kingwell/StudentProcess/generateBill";
									form1.submit();
								  }
							}
