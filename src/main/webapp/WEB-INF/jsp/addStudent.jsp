...
<script src="/asianagencies/js/datePicker/jquery-1.7.1.js"></script>
<script src="/asianagencies/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/asianagencies/js/datePicker/ui/jquery.ui.tabs.js"></script>
...
<script src="/asianagencies/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script src="/asianagencies/JavaScript/actb.js"></script>
<script src="/asianagencies/JavaScript/common.js"></script>
...
<script type="text/javascript">
			...
			function checkContactNo() {
				...
				var selected=document.getElementById('addclass').value;
					...
					xmlHttp.open("GET", "/asianagencies/StudentProcess/checkContactNo?contactnumber="+selected,true);
					xmlHttp.send(null);
			}
					...
					<table style="width: auto;height: auto;" border="0" align="center" id="table1">
						...
						<tr>
						 ...
						 <tr>
							...
							<td ><label> <input name="name" required
									type="text" class="myclass" id="name" size="36"
						...
						<tr>
						 ...
						 <tr>
							...
							<td ><label> <input name="remarks" required
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/asianagencies/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
							...
							function generateBill() {
								...
								if(form1.checkValidity()) {
									form1.savestudent.disabled = true;
									form1.action = "/asianagencies/StudentProcess/generateBill";
									form1.submit();
								  }
							}
