...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/hisabaat/MarksDetailsProcess/searchForGraphicalReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/hisabaat/MarksDetailsProcess/getStudentGraph" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents" >
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<%-- 					<td class="dataTextInActive"><a class="dataTextInActive"
								href="/hisabaat/Controller?process=StudentProcess&action=ViewDetails&id=<c:out value='${Parents.student.sid}'
