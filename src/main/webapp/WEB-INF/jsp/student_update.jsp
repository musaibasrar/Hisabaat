...
%>
<body>
	<form action="/asianagencies/PersonalProcess/viewAll"
						...
						<tr>
							...
							<td class="alignLeft" style="padding-left: 20px;">Contact Number&nbsp;</td>
									...
									<td width="16%"><label> <input
											name="classsec" type="text" class="myclass"
											id="classsec" size="30" value="${student.classstudying}">
						...
						<script type="text/javascript">
							...
							function updateStudent() {
								...
								if(form1.checkValidity()) {
									form1.action = "/asianagencies/StudentProcess/updateStudent";
									form1.submit();
								  }
							}
						</script>
