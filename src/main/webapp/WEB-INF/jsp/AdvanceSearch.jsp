...
%>
<body>
	<form id="form1" action="/asianagencies/UserProcess/advanceSearch"
		method="post">
		<%
				...
				<div id="tabs-1">
					<table width="100%" border="0" align="center" id="table1">
						...
						<tr>
							...
							<td> <label> 
											 <input
									name="addclass" type="text" class="addclass" id="name" size="36">
							</label></td>
 ...
 --%>
						...
						<script type="text/javascript">
							function searchStudent() {
								...
								form1.action = "/asianagencies/UserProcess/advanceSearch";
								form1.submit();
							}
							function searchByParents() {
								var form1 = document.getElementById("form1");
								form1.action = "/asianagencies/UserProcess/advanceSearchByParents";
								form1.submit();
							}
							function Cancel() {
								var form1 = document.getElementById("form1");
