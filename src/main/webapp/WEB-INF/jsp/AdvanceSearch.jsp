...
%>
<body>
	<form id="form1" action="/kingwell/UserProcess/advanceSearch"
		method="post">
		<%
 ...
 --%>
						...
						<script type="text/javascript">
							function searchStudent() {
								...
								form1.action = "/kingwell/UserProcess/advanceSearch";
								form1.submit();
							}
							function searchByParents() {
								var form1 = document.getElementById("form1");
								form1.action = "/kingwell/UserProcess/advanceSearchByParents";
								form1.submit();
							}
							function Cancel() {
								var form1 = document.getElementById("form1");
