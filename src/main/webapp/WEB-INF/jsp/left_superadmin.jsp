...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/asianagencies/StudentProcess/viewAllSuperAdmin" style="font-size: 12px;">View All</a><br/>
            </div>
            ...
            <div>
                ...
                <a target="mainFrame" href="/asianagencies/ClassProcess/viewGraduated" >Graduated Students</a><br/>
                <a target="mainFrame" href="/asianagencies/ClassProcess/viewDropped" >Dropped Out Students</a><br/>
                <a target="mainFrame" href="/asianagencies/ClassProcess/viewLeftOut" >Left Out Students</a><br/>
            </div>
            ...
            <div >
                <a target="mainFrame" href="/asianagencies/sendsms_superadmin" style="font-size: 12px;">SMS</a><br/>
            </div>
