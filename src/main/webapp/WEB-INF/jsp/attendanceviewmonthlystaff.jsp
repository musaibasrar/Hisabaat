...
<script type="text/javascript">
	...
	function searchStaffAttendanceDetailsMonthly() {
		...
		form1.action = "/hisabaat/AttendanceProcess/searchStaffAttendanceDetailsMonthly";
		form1.method = "POST";
		form1.submit();
	...
	function searchStaffAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "/hisabaat/AttendanceProcess/searchStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/hisabaat/AttendanceProcess/updateStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
