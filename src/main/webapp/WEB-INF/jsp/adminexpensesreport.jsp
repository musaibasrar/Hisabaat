...
<script type="text/javascript">
	function addExpenses() {
		...
		form1.action="/hisabaat/AdminProcess/addExpenses";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/hisabaat/AdminProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function searchRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/hisabaat/AdminProcess/viewExpensesBetweenDates";
		form1.method = "POST";
		form1.submit();
	}
...
<body>
	<form id="form1"
		action="/hisabaat/DepartmentProcess/deleteMultiple" method="POST">
		<%
