...
<script type="text/javascript">
	...
	function savePeriods() {
		...
		form1.action = "/kingwell/PeriodProcess/savePeriods";
		form1.method = "POST";
		form1.submit();
	}
	...
	function deleteRecord(){
		var form1 = document.getElementById("form1");
		form1.action = "/kingwell/PeriodProcess/deletePeriods";
		form1.method = "POST";
		form1.submit();
	}
				...
				<tbody>
					...
					<c:forEach items="${employeeList}" var="employeelist">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/kingwell/PeriodProcess/viewTeacherTimeTable?teachername=<c:out value="${employeelist.teachername}" />"><c:out value="${employeelist.teachername}" /></a></td>
