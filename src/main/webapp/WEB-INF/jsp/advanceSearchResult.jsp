    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function refreshPage(){
                 var form1=document.getElementById("form1");
                form1.action="/hisabaat/PersonalProcess/ViewAllGo";
                form1.submit();
            ...
            function redirect(){
                 var form1=document.getElementById("form1");
                    form1.action="/hisabaat/PersonalProcess/redirect";
                    form1.submit();
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/hisabaat/StudentProcess/archiveMultiple" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${searchStudentList}" var="Parents">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/hisabaat/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out value="${Parents.student.studentexternalid}"/></a></td>
