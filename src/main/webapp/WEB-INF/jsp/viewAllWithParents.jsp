    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function viewStudentDetails(sid,branchid){
                var form1=document.getElementById("form1");
               form1.action="/asianagencies/StudentProcess/ViewDetails?id="+sid+"&urlbranchid="+branchid+"";
               form1.submit();
            ...
            <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/asianagencies/StudentProcess/viewAll?page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/asianagencies/StudentProcess/viewAll?page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/asianagencies/StudentProcess/viewAll?page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
