...
<script src="/furnitureworld/js/Chart.js"></script>
...
<link rel="stylesheet" href="/furnitureworld/css/graph/jquery.jqplot.css">
<link rel="stylesheet" href="/furnitureworld/css/graph/jquery.jqplot.min.css">


  <script type="text/javascript" src="/furnitureworld/js/datePicker/jquery-1.7.1.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery-ui-1.8.17.custom.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.dialog.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.autocomplete.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.core.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.widget.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.datepicker.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.accordion.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/sliderAccess.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery-ui-timepicker-addon.js"></script>
        
        
         <script  type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.position.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.mouse.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.draggable.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.resizable.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/graph/jquery.jqplot.js"></script>        
        <script  type="text/javascript" src="/furnitureworld/js/graph/plugins/jqplot.dateAxisRenderer.min.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/graph/plugins/jqplot.barRenderer.min.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/graph/plugins/jqplot.categoryAxisRenderer.min.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/graph/plugins/jqplot.cursor.min.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/graph/plugins/jqplot.highlighter.min.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/graph/plugins/jqplot.dragable.min.js"></script>
        <script type="text/javascript" src="/furnitureworld/js/graph/plugins/jqplot.trendline.min.js"></script>
        <script src="/furnitureworld/js/jquery.jqplot.min.js" ></script>
        <script src="/furnitureworld/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<link rel="stylesheet" href="/furnitureworld/css/validation/jquery.ketchup.css">
<script type="text/javascript" src="/furnitureworld/js/datePicker/jquery-1.7.1.js"></script>
...
<script type="text/javascript" src="/furnitureworld/js/datePicker/ui/jquery.ui.core.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.ui.widget.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="/furnitureworld/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.ui.button.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.ui.accordion.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.effects.core.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.ui.accordion.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.effects.slide.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.effects.bounce.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.effects.clip.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.effects.transfer.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/jquery.effects.blind.js"></script>
<script type="text/javascript"
	src="/furnitureworld/js/datePicker/ui/ScrollableGridPlugin.js"></script>
...
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMonthly() {
		...
		form1.action = "/furnitureworld/AttendanceProcess/searchStudentAttendanceDetailsMonthly";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetailsMonthlyGraph() {
		var form1 = document.getElementById("form1");
		form1.action = "/furnitureworld/AttendanceProcess/searchStudentAttendanceDetailsMonthlyGraph";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "/furnitureworld/AttendanceProcess/searchStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/furnitureworld/AttendanceProcess/updateStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form id="form1" action="/furnitureworld/StampFeesProcess/applyFees" method="POST">
