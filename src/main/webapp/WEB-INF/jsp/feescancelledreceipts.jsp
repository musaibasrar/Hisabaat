...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/asianagencies/FeesCollection/viewCancelledReceipts";
		form1.method = "POST";
		form1.submit();
...
<body>
	<form id="form1"
		action="/asianagencies/FeesDetails/exportDataForFees" method="POST">
                    ...
                    <tbody>
                        <c:forEach items="${searchfeesdetailslistcancelled}" var="feesdetails">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/asianagencies/FeesCollection/ViewDetails?id=<c:out value='${feesdetails.receiptnumber}'/>&sid=<c:out value='${feesdetails.sid}'/>">View Details</a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/asianagencies/FeesCollection/UndoFeesReceipt?id=<c:out value='${feesdetails.receiptnumber}'/>&sid=<c:out value='${feesdetails.sid}'/>"><i class="fa fa-undo" style="color:#1b5605;font-size: 18px;"></i></a></td>
