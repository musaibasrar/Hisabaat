...
<script type="text/javascript">
	function addFeesCategory() {
		...
		form1.action = "/kingwell/FeesProcess/addFeesParticular";
		form1.method = "POST";
		form1.submit();
	 ...
	 function saveaccount(){
		 ...
		 var form1 = document.getElementById("form1");
			...
			if(form1.checkValidity()) {
				var form1=document.getElementById("form1");
		        form1.action="/kingwell/AccountProcess/saveAccount";
		        form1.submit();
			  }
	...
	function deleteRecords(){
		...
		if(confirm('Are you sure, you want to delete the account?')){
			var form1=document.getElementById("form1");
	         form1.action="/kingwell/AccountProcess/deleteAccount";
	        form1.submit();
		}
...
<script type="text/javascript">
    ...
    function getSubGroup() {
		...
		if(selected.includes("Select Group") || selected.includes("New Group")){
			...
			xmlHttp.open("GET", "/kingwell/SubGroupName/getSubGroupNames?groupname="+selected,true);
			xmlHttp.send(null);
		}
    ...
    function getSSGroup() {
		...
		if(selected.includes("Select Sub-Group") || selected.includes("New Sub-Group")){
			...
			xmlHttp.open("GET", "/kingwell/SubGroupName/getSSGroupNames?subgroupname="+selected,true);
			xmlHttp.send(null);
		}
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Account Type<img
							...
							src="/kingwell/css/dataTable/images/sort_both.png" />&nbsp;&nbsp;
						</th>
						...
						<th title="click to sort" class="headerText">Account Code<img
							alt=" " style="position: relative; top: 4px;"
							src="/kingwell/css/dataTable/images/sort_both.png" /></th>
