...
%>
    <frameset    rows="70,*"frameborder="0" border="0" framespacing="0"  >
        <frame   src="/kingwell/header_superadmin"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/kingwell/left_superadmin" name="leftFrame" scrolling="yes"  frameborder="1"   />
