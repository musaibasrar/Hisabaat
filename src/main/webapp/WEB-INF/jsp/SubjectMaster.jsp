...
<script type="text/javascript">
	function addSubjects() {
		...
		form1.action = "/kingwell/SubjectDetailsProcess/addSubjectMaster";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/kingwell/SubjectDetailsProcess/deleteMultipleSubjects";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/kingwell/SubjectDetailsProcess/deleteMultipleSubjects" method="POST">
		<%
