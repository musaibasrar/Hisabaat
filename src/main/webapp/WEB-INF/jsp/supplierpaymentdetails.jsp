...
<script type="text/javascript">
	function search() {
		...
		if(form1.checkValidity()) {
			form1.action = "/asianagencies/MessSuppliersProcess/searchSupplierPaymentDetails";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/asianagencies/MessSuppliersProcess/printSearchSupplierPaymentDetails";
			form1.method = "POST";
			form1.submit();
	}
