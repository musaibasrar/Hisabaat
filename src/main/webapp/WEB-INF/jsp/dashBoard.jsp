...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/kingwell/css/datePicker/jquery-ui-1.8.17.custom.css">
        <link rel="stylesheet" href="/kingwell/css/datePicker/demos.css">
        <!--<script type="text/javascript" language="javascript" src="/kingwell/js/dataTable/jquery.js"></script>-->
        <script type="text/javascript" src="/kingwell/js/datePicker/jquery-1.7.1.js"></script>
        <script type="text/javascript" language="javascript" src="/kingwell/js/dataTable/jquery.dataTables.js"></script>
        ...
        <script type="text/javascript" src="/kingwell/js/datePicker/ui/jquery.ui.button.js"></script>
...
-->
        ...
        <script type="text/javascript">
            ...
            function ViewAll(){
                ...
                form1.action="/kingwell/PersonalProcess/viewAll";
                form1.submit();
            }
        </script>
